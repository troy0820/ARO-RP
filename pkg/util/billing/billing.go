...
type Manager interface {
	Ensure(context.Context, *api.OpenShiftClusterDocument, string) error
...
func (m *manager) Ensure(ctx context.Context, doc *api.OpenShiftClusterDocument, tenantID string) error {
